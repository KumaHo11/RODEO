            ...
            <AnimatePresence mode="wait">
              ...
              {inputMode === 'file' && (
                <motion.div key="file" initial={{ opacity: 0, y: 4 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="space-y-3">
                  <label className="flex flex-col items-center justify-center gap-3 md:gap-4 py-8 md:py-14 border-2 border-dashed border-gray-200 rounded-2xl cursor-pointer hover:border-green-400 hover:bg-green-50/30 transition-all group">
                    <div className="w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-gray-50 group-hover:bg-green-50 border border-gray-100 group-hover:border-green-200 flex items-center justify-center transition-all">
                      <Upload className="w-6 h-6 md:w-7 md:h-7 text-gray-300 group-hover:text-green-500 transition-colors" />
                    </div>
                    <div className="text-center space-y-1 px-4">
                      ...
                      <p className="text-[10px] text-gray-300 font-normal">Soporta .kml y .geojson</p>
                    </div>
