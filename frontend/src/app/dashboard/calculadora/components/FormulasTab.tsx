...
function RO({ label, value, unit }: { label: string; value: string; unit: string }) {
  return (
    <div className="space-y-1">
      <label className="text-[10px] text-gray-500 font-medium block">{label}</label>
      <div className="w-full bg-gray-50 border border-gray-100 rounded-lg px-3 py-1.5 text-sm text-gray-500 font-mono">
...
function RodeoBadge() {
  return (
    <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full text-[9px] font-black bg-green-100 text-green-700 border border-green-200 ml-2 align-middle">
      ✦ Rodeo
    </span>
  )
}
    ...
    <div className="bg-white border border-gray-100 shadow-sm rounded-xl overflow-hidden flex flex-col">
      <div className="px-4 py-3.5 border-b border-gray-50">
        <div className="flex items-start gap-2">
          <span className="shrink-0 text-[10px] font-black text-gray-400 bg-gray-100 rounded-md px-1.5 py-0.5 mt-0.5 tabular-nums">{num}</span>
          <div>
        ...
        <div className="mt-2.5 bg-gray-50 border border-gray-100 px-3 py-1.5 rounded-lg font-mono text-[10px] text-gray-600 overflow-x-auto whitespace-nowrap">
          {formula}
        </div>
      </div>
...
function TecnicasGrid() {
  ...
  return (
    <div className="space-y-6">
      <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Manejo holístico — Allan Savory</p>
      ...
      <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Pastoreo racional Voisin (PRV)</p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Ganadería tradicional y extensiva</p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Suplementación, feedlot y reservas forrajeras</p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
...
export function FormulasTab() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      {/* Segmented control — switcher de herramientas, NO navegación */}
      <div className="bg-gray-100 rounded-xl p-1 flex gap-1">
        {SECCIONES.map(({ key, label, desc }) => (
          <button
            ...
            className={clsx(
              'flex-1 flex flex-col items-start px-3 py-2.5 rounded-lg text-left transition-all',
              seccion === key
                ? 'bg-white shadow-sm'
                : 'hover:bg-white/50'
            )}
