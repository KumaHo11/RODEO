      ...
      <div className="bg-white border border-gray-100 rounded-xl p-5 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="space-y-1.5">
            ...
            <input type="number" value={temp} min={0} max={50} onChange={e => setTemp(+e.target.value || 0)}
              className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-900 focus:border-green-500 outline-none" />
          </div>
          {cat.needsPV && (
            <div className="space-y-1.5">
              <label className="text-[10px] text-gray-500 font-medium block">Peso vivo promedio (kg)</label>
              <input type="number" value={pv} min={1} onChange={e => setPv(+e.target.value || 1)}
                className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-900 focus:border-green-500 outline-none" />
            </div>
          )}
          {cat.extraLabel && (
            <div className="space-y-1.5">
              ...
              <input type="number" value={extra} min={0} step={0.1} onChange={e => setExtra(+e.target.value || 0)}
                className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-900 focus:border-green-500 outline-none" />
            </div>
          )}
        </div>
