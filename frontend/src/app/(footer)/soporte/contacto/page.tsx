                ...
                <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
                  ...
                  {status === 'error' && (
                    <p className="text-red-600 text-sm bg-red-50 border border-red-100 rounded-xl px-4 py-3">
                      ...
                      <a href="mailto:josorio@rodeoagtech.com" className="font-bold underline">soporte@rodeoagtech.com</a>.
                    </p>
                  )}
                ...
                <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:josorio@rodeoagtech.com" className="text-sm font-bold text-green-600 hover:text-green-700">
