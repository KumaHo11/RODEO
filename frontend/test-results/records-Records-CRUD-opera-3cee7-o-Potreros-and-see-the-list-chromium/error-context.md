...
- Name: records.spec.ts >> Records CRUD operations >> Should be able to navigate to Potreros and see the list
- Location: tests/records.spec.ts:67:7
...
Call log:
  - waiting for locator('text=Nuevo potrero') to be visible
    - waiting for" http://localhost:3000/login?next=%2Fdashboard%2Fpaddocks-list" navigation to finish...
    - navigated to "http://localhost:3000/login?next=%2Fdashboard%2Fpaddocks-list"
